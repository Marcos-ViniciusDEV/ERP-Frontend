  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white scroll-smooth text-slate-900">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold px-5 py-4 rounded-full shadow-2xl transition-all hover:scale-110 active:scale-95"
